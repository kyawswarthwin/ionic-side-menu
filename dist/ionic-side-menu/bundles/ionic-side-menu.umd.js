(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/common'), require('@ionic/angular'), require('@angular/core'), require('@angular/platform-browser'), require('@angular/router')) :
    typeof define === 'function' && define.amd ? define('ionic-side-menu', ['exports', '@angular/common', '@ionic/angular', '@angular/core', '@angular/platform-browser', '@angular/router'], factory) :
    (factory((global['ionic-side-menu'] = {}),global.ng.common,global.angular,global.ng.core,global.ng.platformBrowser,global.ng.router));
}(this, (function (exports,common,angular,core,platformBrowser,router) { 'use strict';
